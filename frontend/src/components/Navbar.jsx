    ...
    <>
      ...
      {!user && (
        <>
          ...
          <button 
            className='w-full lg:w-auto text-white font-semibold bg-neon-yellow p-2 px-4 rounded-2xl mb-2 lg:mb-0'
            onClick={() => setIsMobileMenuOpen(false)}
          >
            Sign Up
          </button>
      ...
      {user && (
        <>
          <button 
            ...
            className='w-full lg:w-auto text-white hover:scale-105 transition-transform duration-300 ease-in-out cursor-pointer font-semibold bg-neon-yellow p-2 px-4 rounded-full mb-2 lg:mb-0'
          >
            Log out
          </button>
          <div className='flex items-center justify-center lg:justify-start gap-2 py-2 lg:py-0'>
            <img 
              src={user.avatar} 
              className='w-8 h-8 rounded-full border-4 border-neutral-900' 
              alt="User Avatar" 
            />
          </div>
        </>
    ...
    <>
      ...
      >
        ...
        <div className='lg:min-w-1/2 lg:h-2/3 lg:flex lg:items-center lg:justify-center'>
          <div className='lg:min-w-2/3 lg:h-full lg:flex lg:justify-evenly lg:items-center gap-3'>
            <NavLinks />
            <button
              onClick={() => toggleTheme()}
